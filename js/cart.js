(function () {
  ...
  function renderCart() {
    ...
    // Añadir "Continue Shopping" siempre (sin tocar el HTML interno anterior)
    const existingBtn = container.querySelector('#btn-continue-shopping');
    if (!existingBtn) {
      const continueBtn = document.createElement('div');
      continueBtn.classList.add('text-center', 'mt-3');
      continueBtn.innerHTML = '<button class="btn btn-outline-primary btn-lg rounded-1 w-100" id="btn-continue-shopping" data-bs-dismiss="offcanvas">Continue Shopping</button>';
