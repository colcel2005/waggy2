(function () {
  ...
  function updateBadges() {
    ...
    const badges = document.querySelectorAll('#cart-badge, #cart-badge-mobile, #cart-badge-desktop, #cart-badge-offcanvas');
  ...
  function renderCart() {
    ...
    // Añadir botón "Continue Shopping" siempre visible
    const existingBtn = document.getElementById('btn-continue-shopping');
    if (!existingBtn) {
      const continueDiv = document.createElement('div');
      continueDiv.className = 'text-center mt-3';
      continueDiv.innerHTML = '<button class="btn btn-outline-primary btn-lg rounded-1 w-100" id="btn-continue-shopping" data-bs-dismiss="offcanvas">Continue Shopping</button>';
  ...
  // Añadir producto al carrito (CORREGIDO: evita doble ejecución)
  ...
  function addToCart(product) {
    ...
    setTimeout(() => { addingToCart = false; }, 100);
  }
  ...
  // Inicializar eventos en los botones "Add to Cart" (SOLO el padre .btn-cart)
  ...
  function handleAddToCart(e) {
    ...
    // Tomamos los datos del elemento .btn-cart (padre)
